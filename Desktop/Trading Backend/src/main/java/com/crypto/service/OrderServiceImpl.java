...
public class OrderServiceImpl implements OrderService {
    ...
    public Order buyAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        if (oldAsset == null) {
            ...
            // For BUY: Add the quantity (positive)
            assetService.updateAssets(oldAsset.getId(), quantity);
        }
        return savedOrder;
    }
    ...
    public Order sellAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        // Process payment (should add money to wallet for sell orders)
        walletService.payOrderPayment(order, user);

        // For SELL: Subtract the quantity (pass negative value)
        Asset updatedAsset = assetService.updateAssets(assetToSell.getId(), -quantity);
